...
pub mod edit {
    ...
    use pikuseru::utils::Widget;

    use gfx::Screen;
    use config::Players;
    use pikuseru::{PikuseruCartridge, PikuseruConfig, Palettes};
    ...
    impl Editor {
        ...
        pub fn init(&mut self, config: Arc<Mutex<PikuseruConfig>>, palettes: Arc<Mutex<Palettes>>, screen: &mut Screen, filename: String, code: String) {
        ...
        pub fn update(&mut self, _cartridge: &mut PikuseruCartridge, screen: &mut Screen, players: Arc<Mutex<Players>>) -> bool {
