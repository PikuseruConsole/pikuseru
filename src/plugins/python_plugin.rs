...
pub mod plugin {
    ...
    // Graphics
    py_class!(class PikuseruGraphic |py| {
    ...
    // Input
    py_class!(class PikuseruInput |py| {
    ...
    // Info
    py_class!(class PikuseruInfo |py| {
    ...
    // Audio
    py_class!(class PikuseruAudio |py| {
    ...
    impl PythonPlugin {
        ...
        pub fn load(&mut self,
            ...
            let pikuseru_graphic_obj = PikuseruGraphic::create_instance(py, screen.clone()).unwrap();
            self.mydict.set_item(py, "pikuseru_graphic", pikuseru_graphic_obj).unwrap();

            let pikuseru_input_obj = PikuseruInput::create_instance(py, contexts.clone()).unwrap();
            self.mydict.set_item(py, "pikuseru_input", pikuseru_input_obj).unwrap();

            let pikuseru_map_obj = PikuseruMap::create_instance(py, screen.clone()).unwrap();
            self.mydict.set_item(py, "pikuseru_map", pikuseru_map_obj).unwrap();

            let pikuseru_info_obj = PikuseruInfo::create_instance(py, info.clone()).unwrap();
            self.mydict.set_item(py, "pikuseru_info", pikuseru_info_obj).unwrap();  

            let pikuseru_audio_obj = PikuseruAudio::create_instance(py, audio.clone()).unwrap();
            self.mydict.set_item(py, "pikuseru_audio", pikuseru_audio_obj).unwrap();  


            py.run(r###"globals()["pikuseru_graphic"] = pikuseru_graphic;"###,
                     None,
                     Some(&self.mydict))
                .unwrap();
            py.run(r###"globals()["pikuseru_input"] = pikuseru_input;"###,
                     None,
                     Some(&self.mydict))
                .unwrap();
            py.run(r###"globals()["pikuseru_map"] = pikuseru_map;"###,
                     None,
                     Some(&self.mydict))
                .unwrap();
            py.run(r###"globals()["pikuseru_info"] = pikuseru_info;"###,
                None,
                Some(&self.mydict))
                .unwrap();
            py.run(r###"globals()["pikuseru_audio"] = pikuseru_audio;"###,
                None,
                Some(&self.mydict))
                .unwrap();
